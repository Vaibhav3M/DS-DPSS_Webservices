...
public class AdminClient {
    ...
    private static boolean setupCORBA(String[] arguments){
        try {
            ...
            QName qNameAmerica = new QName("http://serverImplementation/","");
            ...
            QName qNameAsia = new QName("http://serverImplementation/","");
            ...
            QName qNameEurope = new QName("http://serverImplementation/","");
